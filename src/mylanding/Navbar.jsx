...
function Navbar(){
  ...
  function toggle(){
    ...
    return(
        <div>
        <nav className="flex justify-center px-[12rem] py-[2rem] sm:px-5">
        <div className="w-[100%] flex justify-between ">

          <div className="sm:flex sm:gap-[16.5rem]">
          <img src={Logo} alt="" className="w-[5rem] mt-6 sm:w-[5rem] sm:mt-2" />


          <div className="hidden " onClick={toggle}>
          ...
          <ul className={ clicked ? "sm:block sm: bg-black sm: text-white sm:absolute sm:top-[4rem] sm:right-1 sm:-full sm:h-[50rem] sm:px-[2rem] sm:w-full "   : " flex items-center relative sm:hidden" }>
            ...
            <div className="flex w-[8rem] p-2 group">
              ...
              <div className="hidden group-hover:block px-8 py-4 text-lg shadow-lg bg-white w-[25rem] h-[20rem] absolute font-medium top-[4rem] -left-[5rem] sm:hidden sm:group-hover sm:left-5 sm:top-[15rem] sm:w-[20rem] sm:text-sm">
                <div className="flex mb-6 gap-3">
                    ...
                    <p className="text-gray-600">here is why 250+ Buisnesses and Developers use Mono APIs</p>
                    </div>
                ...
                <div className="flex mb-6 gap-3">
                    ...
                    <p className="text-gray-600">Affordable pricing for Developers, SMEs and enterprises</p>
                    </div>
                </div>
                <div className="flex mb-6 gap-3">
                    <img src={btn} alt="" />
                    ...
                    <p className="text-gray-600">Experience Mono APIs in Action</p>
                    </div>
                </div>
              </div>
            ...
            <div className="flex w-[8rem] p-2 group">
              ...
              <img src={arrowDown} alt="" className="w-[20px]" />
               <div className=" hidden group-hover:block px-8 py-4 text-lg shadow-lg bg-white w-[55rem] h-[17rem] absolute font-medium top-[4rem] -left-[5rem] 
                ...
                <div className="flex mb-6 gap-3">
                    ...
                    <p className="text-gray-600">Financial Account Linking</p>
                    </div>
                ...
                <div className="flex mb-6 gap-3">
                    ...
                    <p className="text-gray-600">Direct Bank payment collection</p>
                    </div>
                </div>
                <div className="flex mb-6 gap-3">
                    <img src={portal} alt="" />
                    ...
                    <p className="text-gray-600">Linked Account Management</p>
                    </div>
                </div>
                </div>
                ...
                <div className="flex mb-6 gap-3">
                    ...
                    <p className="text-gray-600">No-code Bank statement collection</p>
                    </div>
                ...
                <div className="flex mb-6 gap-3">
                    ...
                    <p className="text-gray-600">No-code Bank payment collection</p>
                    </div>
                </div>
                <div className="flex mb-6 gap-3">
                    <img src={percept} alt="" />
                    ...
                    <p className="text-gray-600">Corporate finance Management</p>
                    </div>
                </div>
              </div>
              </div>
          ...
          <button className="lg: p-4 bg-[#0055ba] text-white rounded-lg sm:hidden">
            Create Free Account
          </button>
        </div>
      </nav>
